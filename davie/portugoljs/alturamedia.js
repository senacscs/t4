...
function altura() {
    ...
    altura3 = parseFloat(document.getElementById("altura3").value);

    media_altura = (altura1 + altura2 + altura3) / 3;

    alert("Resultado recebido.")
    document.write("A média das alturas ficou: ", Math.round(media_altura, 2), " metros.")
}
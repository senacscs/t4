...
const ProjetosP = [  
    ...
    { "nome": "Site de Triângulos", "url": "triangulos"},
    { "nome": "Poemas", "url": "poema"},
    { "nome": "Ponte Da Vinci", "url": "pontedavinci"},
    { "nome": "Imersão", "url": "imersao1"},
    { "nome": "Autocuidado", "url": "autocuidado"}, 
    { "nome": "Site de tecnologia", "url": "tecnologiamat"},  
    { "nome": "Jogo Escape Room", "url": "jogo1"},   
    { "nome": "Site feito a mão", "url": "teste_ods"},  
    { "nome": "Oficina da zoeira", "url": "oficina"},  
